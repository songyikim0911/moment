...
import com.days.moment.setting.config.SettingRootConfig;
...
@Log4j2
@Configuration
@Import({NoticeRootConfig.class, BoardRootConfig.class, QnaRootConfig.class, MiniRootConfig.class, SettingRootConfig.class})
