        ...
        <form id="form1" action="/miniboard/write" method="post">
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" name="mbTitle" class="form-control" id="exampleInputEmail1" placeholder="Enter Title">
            </div>
              ...
              <div class="form-group">
                ...
                <textarea name="mbContent" class="form-control" rows="3" placeholder="Enter ..."></textarea>
              </div>
