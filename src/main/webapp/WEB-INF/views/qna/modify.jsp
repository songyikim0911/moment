            ...
            <form id="form1">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="mbTitle" class="form-control" id="exampleInputEmail1" placeholder="Enter Title"value="<c:out value="${miniDTO.mbTitle}"></c:out>">
                  </div>
                <div class="col-sm-12">
                  <!-- textarea -->
                  <div class="form-group">
                    <label>Textarea</label>
                    <textarea name="mbContent" class="form-control" rows="3" placeholder="Enter ..."><c:out value="${miniDTO.mbContent}"></c:out></textarea>
                  </div>
                </div>
                <div class="form-group">
