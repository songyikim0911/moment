        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">QnA Register</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form id="form1" action="/qna/register" method="post">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="writer" class="form-control" id="exampleInputEmail2" placeholder="Enter Writer" readonly value="email0@naver.com">
                </div>
                <div class="row">
                  <div class="col-sm-12">
                    <!-- textarea -->
